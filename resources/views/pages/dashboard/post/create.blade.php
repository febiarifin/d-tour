        ...
        <div class="container-fluid p-0">
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="maps_url"
                                        ...
                                        placeholder="Masukkan url google maps" value="{{ old('maps_url') }}" required>
                                    @error('maps_url')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="card" style="height: 315px;">
                            <div class="card-body">
                                ...
                                <div class="mt-1 mb-1">
                                    <center>
                                        <img class="file-preview mt-3" src="{{ asset('img/image-default.png') }}"
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @enderror
                                <textarea name="description" cols="5" rows="5" class="form-control" required>{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-primary"><span class="align-middle"> <i
                            class="fa-solid fa-floppy-disk"></i> Add</span></button>
            </form>
        </div>
    </main>
